# DistributedJets.jl contributor guidelines

## Issue reporting
If you have found a bug in DistributedJets.jl or have any suggestions for changes to
DistributedJets.jl functionality, please consider filing an issue using the GitHub
...
making changes to DistributedJets.jl.
...
git:
  1. fork the DistributedJets.jl repository
  ...
  4. run `]test DistributedJets` in the `test` folder
