...
SUITE["DBlock, homogeneous"]["dom,block"] = @benchmarkable getblock($m, $domainF, 3)
SUITE["DBlock, homogeneous"]["dom,block!"] = @benchmarkable setblock!($m, $domainF, 3, $(rand(100)))
SUITE["DBlock, homogeneous"]["rng,block"] = @benchmarkable getblock($d, $rangeF, 10)
SUITE["DBlock, homogeneous"]["rng,block!"] = @benchmarkable setblock!($d, $rangeF, 10, $(rand(100)))
...
SUITE["DBlock, heterogeneous"]["dom,block"] = @benchmarkable getblock($m, $domainF, 3)
SUITE["DBlock, heterogeneous"]["dom,block!"] = @benchmarkable setblock!($m, $domainF, 3, $(rand(100)))
SUITE["DBlock, heterogeneous"]["rng,block"] = @benchmarkable getblock($d, $rangeF, 10)
SUITE["DBlock, heterogeneous"]["rng,block!"] = @benchmarkable setblock!($d, $rangeF, 10, $(rand(100)))
