...
SUITE["DBArray"]["f-maximum"] = @benchmarkable maximum(abs, $d₁)
SUITE["DBArray"]["f-minimum"] = @benchmarkable minimum(abs, $d₁)
SUITE["DBArray"]["maximum"] = @benchmarkable maximum($d₁)
SUITE["DBArray"]["minimum"] = @benchmarkable minimum($d₁)
SUITE["DBArray"]["mapreduce"] = @benchmarkable mapreduce(abs, +, $d₁)
